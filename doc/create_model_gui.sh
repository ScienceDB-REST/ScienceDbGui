...
admin_gui_gen . --baseUrl '//api.reconstructdb.org' --name individual --attributes 'name:string, sowing_date:date, harvest_date:date' --belongsTos 'cultivar:cultivar_id:id:genotype:description, field_plot:field_plot_id:id:field_name:location_code, pot:pot_id:id:pot:greenhouse'
...
admin_gui_gen . --baseUrl '//api.reconstructdb.org' --name sample_measurement --attributes 'variable:string, value:numeric, unit:string' --belongsTos 'sample:sample_id:name:id:material'

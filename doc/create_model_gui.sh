...
admin_gui_gen . --baseUrl 'http://213.136.88.239:3000' --name sample_measurement --attributes 'variable:string, value:numeric, unit:string' --belongsTos 'sample:sample_id:name:id:material'

<template>
  <div class="ui container">
    ...
    <vuetable ref="vuetable"
      ...
      pagination-path=""
      :per-page="20"
      detail-row-component="field_plot-detail-row"
...
import field_plotCustomActions from './field_plotCustomActions.vue'
...
Vue.component('field_plot-custom-actions', field_plotCustomActions)
Vue.component('field_plot-detail-row', field_plotDetailRow)
...
export default {
      ...
      fields: [{
        ...
        //},
            ...
            sortField: 'location_code'
                  ...
                  {
            name: 'soil_treatment',
            sortField: 'soil_treatment'
          },
                {
          name: '__component:field_plot-custom-actions',
          title: 'Actions',
          titleClass: 'center aligned',
          dataClass: 'center aligned'
        }
  ...
  methods: {
    ...
    downloadExampleCsv: function() {
      var t = this
      axios.get(t.$baseUrl() + '/field_plots/example_csv', {
        headers: {
          'authorization': `Bearer ${t.$getAuthToken()}`,
          'Accept': 'application/json'
        },
        ...
        link.href = url;
        link.setAttribute('download', 'field_plots.csv');
    ...
    downloadCsv: function() {
      var t = this
      axios.get(t.$baseUrl() + '/field_plots/csv_export', {
        headers: {
          'authorization': `Bearer ${t.$getAuthToken()}`,
          'Accept': 'application/json'
        },
        ...
        const link = document.createElement('a');
        link.href = url;
        link.setAttribute('download', 'exported_field_plots.csv');
        document.body.appendChild(link);
        link.click();
      }).catch(res => {
        var err = (res && res.response && res.response.data && res.response
